...
#. Optionally you can install `GitKraken <https://www.gitkraken.com//>`_ to manage your repositories
...
.. tabs::
   ...
   .. group-tab:: Linux
        ...
        Install `gcc <https://gcc.gnu.org/>`_ The minimal version required is 7
        or `clang <http://clang.llvm.org/>`_ The minimal version required is 6.0
        ...
        And some basic development libraries :
