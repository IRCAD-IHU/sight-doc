...
.. _SADDataMigrationContextVersion:
...
patcher::DefaultPatcher
    ...
    recursively on each sub-object and then applies the semantic patches recursively on each sub-object .
